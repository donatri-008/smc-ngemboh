...
class LambangMeaningSeeder extends Seeder
{
    ...
    {
        $data = [
            // Global urutan 1, 3, 5, 7, 9 -> kolom kiri
            [
                'judul'  => 'Long-Econ',
                ...
                'icon'   => 'assets/9-logo/long-econ.webp',
                'posisi' => 'kiri',
                'urutan' => 1,
            ],
            [
                ...
                'icon'   => 'assets/9-logo/dua-lengkung.webp',
                'posisi' => 'kiri',
                'urutan' => 2,
            ],
            [
                ...
                'icon'   => 'assets/9-logo/posisi-melingkar.webp',
                'posisi' => 'kiri',
                'urutan' => 3,
            ],
            [
                ...
                'icon'   => 'assets/9-logo/perna-viridis.webp',
                'posisi' => 'kiri',
                'urutan' => 4,
            ],
            [
                ...
                'icon'   => 'assets/9-logo/kerang-terbuka.webp',
                'posisi' => 'kiri',
                'urutan' => 5,
            ],

            // Global urutan 2, 4, 6, 8 -> kolom kanan
            [
                ...
                'icon'   => 'assets/9-logo/gelombang-laut.webp',
                'posisi' => 'kanan',
                'urutan' => 1,
            ],
            [
                ...
                'icon'   => 'assets/9-logo/garis-melengkung.webp',
                'posisi' => 'kanan',
                'urutan' => 2,
            ],
            [
                ...
                'icon'   => 'assets/9-logo/empat-titik.webp',
                'posisi' => 'kanan',
                'urutan' => 3,
            ],
            [
                ...
                'icon'   => 'assets/9-logo/kombinasi-warna.webp',
                'posisi' => 'kanan',
                'urutan' => 4,
            ],
        ];
